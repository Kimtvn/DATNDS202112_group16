...
def score_info(data,col,score_dict): # score_info(data,'score',rfm_score_dict)
...
#     fig, ax = plt.subplots()
#     ax = px.pie(df_new, values='%income', names='RFM_Level',
#            title='Phần trăm doanh thu từ các nhóm khác nhau')
#     st.pyplot(fig)
    
#     fig,ax = plt.subplots()
#     ax.pie(df_new['%income'],labels=df_new.RFM_Level,autopct='%1.1f%%',startangle=90)
#     ax.set_title('Phần trăm doanh thu từ các nhóm khác nhau')
