...
nhung_dict = {
    'best': 'Nhóm best: Tập trung nhóm khách hàng chiếm % doanh thu cao nhất (trên 63%), có tần suất hoạt động cao và có hoạt động gần đây, là nhóm khách hàng giá trị nhất (444, 344, 434)',
...
if choice == 'RFM':
    ...
    with st.expander('RFM score'):
        score_info(data,'score',rfm_score_dict)
...
# =======================================================================
    ...
    # input
    rec_opt = st.date_input('The lates transaction was:',datetime.date(2011, 12, 10),
...
#     st.write(rec_opt,freq_opt,mone_opt)
    st.write(r,f,m,d)
